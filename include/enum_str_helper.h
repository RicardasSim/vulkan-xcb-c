/*
enum strings helper
(acording Vulkan API specification 1.1.122)
*/

#ifndef ENUM_STR_HELPER_H
#define ENUM_STR_HELPER_H

#include <vulkan/vulkan.h>

char* str_VkFormat(VkFormat val)
{
    switch(val)
    {
...
char* str_VkPhysicalDeviceType(VkPhysicalDeviceType val)
{
    switch (val)
    {
        ...
        default:
            return "Unhandled VkPhysicalDeviceType value";
    }
}

char* str_VkColorSpaceKHR(VkColorSpaceKHR val)
{
    switch (val)
    {
        ...
        default:
            return "Unhandled VkColorSpaceKHR value";
    }
}

char* str_VkPresentModeKHR(VkPresentModeKHR val)
{
    switch (val)
    {
        ...
        default:
            return "Unhandled VkPresentModeKHR value";
    }
}

char* str_VkObjectType(VkObjectType val)
{
    switch (val)
    {
